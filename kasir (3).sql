...
--
-- Host: localhost
-- Generation Time: Feb 26, 2024 at 10:39 AM
...
(2, 'indomie', 5000.00, 100),
(4, 'geprek', 150000.00, 57),
(5, 'mie', 2000.00, 3),
(6, 'nasi goreng', 12000.00, 83),
(7, 'pecel lele', 15000.00, 42),
(8, 'seblak', 20000.00, 73);
...
--
ALTER TABLE `pelanggan`
  MODIFY `PelangganID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1202034548;
